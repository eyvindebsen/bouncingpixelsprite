1 dEfna(b)=aB(t-int(t/b)*b-b/2):v=53269:pOv,1:pOv+2,1:pOv+8,1:?"{clear}{blue}{reverse on}{191}{191}{191}";
2 pOv+18,14:pO2040,16:fOt=.tov:ift<19then?"@{reverse off}@a{reverse on}{191}{191}{191}{left*3}";
